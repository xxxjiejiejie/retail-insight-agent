  ...
  rag_ablation: {
    ...
    pipelines: {
      vector: {
        ...
        p50_latency_ms: 42,
        p95_latency_ms: 71,
        evaluated_answerable_cases: 70,
        failure_count: 20,
        negative_nonempty_rate: 1,
        negative_mean_top_score: 0.61,
      },
      bm25: {
        label: "BM25",
        hit_at_5: 0.3286,
      ...
      rrf: {
        ...
        failure_count: 34,
        negative_nonempty_rate: 1,
        negative_mean_top_score: 0.031,
      },
      rrf_reranker: {
        label: "RRF + BGE Reranker",
        hit_at_5: 0.8429,
        mrr_at_5: 0.825,
        ndcg_at_5: 0.8236,
        p50_latency_ms: 168,
